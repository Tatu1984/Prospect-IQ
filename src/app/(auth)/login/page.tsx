  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
      ...
      <div className="space-y-3">
        <button
          type="button"
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-card px-4 py-2.5 text-sm font-medium transition-colors hover:bg-muted opacity-50 cursor-not-allowed"
          disabled
        >
